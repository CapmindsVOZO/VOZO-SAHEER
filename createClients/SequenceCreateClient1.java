...
public class SequenceCreateClient1 {
...
@Test(invocationCount = 5)
	public  void Sequencecreatclient() throws InterruptedException {
		...
		WebDriverManager.chromedriver().setup();
		  ...
		  driver.findElement(By.xpath("//input[@id='formGridEmail']")).sendKeys("vijay");
		  
		  driver.findElement(By.xpath("//input[@id='formGridPassword']")).sendKeys("kumar"); 
		  
		  driver.findElement(By.xpath("//input[@name='email_id']")).sendKeys("vijay@gmail.com");
