...
public class SequenceCreateClient2 {
@Test(timeOut = 400000)
	public  void Sequencecreatclient() throws InterruptedException {
		...
		WebDriverManager.chromedriver().setup();
		  ...
		  driver.findElement(By.xpath("//input[@id='formGridEmail']")).sendKeys("ram");
		  
		  driver.findElement(By.xpath("//input[@id='formGridPassword']")).sendKeys("kumar"); 
		  
		  driver.findElement(By.xpath("//input[@name='email_id']")).sendKeys("ram@gmail.com");
		  
		  driver.findElement(By.xpath("(//input[@name='phone_number'])[1]")).sendKeys("876094321");
