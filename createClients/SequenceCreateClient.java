...
public class SequenceCreateClient {
	
	@Test(invocationCount = 5)
	public  void Sequencecreatclient() {
		...
		WebDriverManager.chromedriver().setup();
		  ...
		  driver.findElement(By.xpath("//input[@id='formGridEmail']")).sendKeys("hari");
		  
		  driver.findElement(By.xpath("//input[@id='formGridPassword']")).sendKeys("kumar"); 
		  
		  driver.findElement(By.xpath("//input[@name='email_id']")).sendKeys("hari@gmail.com");
		  
		  driver.findElement(By.xpath("(//input[@name='phone_number'])[1]")).sendKeys("876543322");
