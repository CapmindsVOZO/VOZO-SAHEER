...
public class Parallel_Login extends Parallel_Base {
	...
	@FindBy(how = How.XPATH, using = "//a[normalize-space()='Patient']")
	WebElement clickPatient;

	public Parallel_Login getclickPatient() throws InterruptedException {
	...
	@FindBy(how = How.XPATH, using = "//button[normalize-space()='Create New Client']")
	WebElement createclient;

	public Parallel_Login getcreateclient() throws InterruptedException {
